...
public interface MySpecialSignConstLibary {
    ...
    public final static String STRICH = "-";
    ...
    public final static String BIGGER_OPERATOR = "<";
    public final static String SMALER_OPERATOR = ">";
    public final static String BRACKET_ROUND_RIGHT = ")";
    public final static String BRACKET_ROUND_LEFT = "(";
    public final static String BRACKET_SQUARE_RIGHT = "]";
